...
import { UploadCSVTableRowChartTooltip, UPLOAD_CSV_TABLE_CHART } from '@client/upload-csv';
...
export const UploadCSVTableRowChart = memo(({ paymentDetails, chartWidth }: Props) => {
  ...
  if (isLoading) {
    return (
      <td colSpan={UPLOAD_CSV_TABLE_CHART.numCols} className="bg-white border-t-1 border-b-1 border-gray-500 px-4">
        {renderTitle()}
  ...
  return (
    <td colSpan={8} className="bg-white border-t-1 border-b-1 border-gray-500 px-4">
      ...
      <VictoryChart
        ...
        width={chartWidth}
        domainPadding={UPLOAD_CSV_TABLE_CHART.domainPadding}
        height={UPLOAD_CSV_TABLE_CHART.chartHeight}
        padding={UPLOAD_CSV_TABLE_CHART.chartPadding}
        ...
        <VictoryAxis
          ...
          style={{
            ...
            tickLabels: {
              ...
              fontSize: UPLOAD_CSV_TABLE_CHART.xAxisFontSize,
              fontWeight: UPLOAD_CSV_TABLE_CHART.xAxisFontWeight,
              padding: UPLOAD_CSV_TABLE_CHART.xAxisPadding,
